...
## Side-by-side modelling for active travel

::: {.column width="60%"}

Side-by-side modelling is necessary for proper active travel modelling but is outside the scope of the current project.
...
![](images/seminar/osm2streets-side-by-side.png)
